...
- Software Carpentries Git Tutorial: [Version Control with Git ](https://swcarpentry.github.io/git-novice/) {{<popup-citation title="Version Control with Git: Summary and Setup">}}
...
{{<popup-citation title="Introduction to version control with Git - Why we want to track versions and how to go back in time to a working version — Introduction to version control with Git documentation">}}
