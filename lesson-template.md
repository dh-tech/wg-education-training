...
# If you use a section header, it will autopopulate into the Table of contents
...
Your lesson can go on for as long as you like, and use whatever organization you find approrpiate, but we recommend you end it with a list of resources, like this:
